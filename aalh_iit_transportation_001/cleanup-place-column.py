        ...
        try:
            if placefield != None: 
                ...
                if testvar.find('Maumee') != -1:
                    ...
                    print(ws.cell(row=iterationrow, column=targetcol).value)
                elif testvar.find('South Bass Islans') != -1:
                    ws.cell(row=iterationrow, column=targetcol).value = 'Put-in-Bay Township (Ohio); Ottawa County (Ohio)'
                    print(ws.cell(row=iterationrow, column=targetcol).value)
                    ...
                    if testvar.find('Indiana') != -1:
                        ...
                        print(ws.cell(row=iterationrow, column=targetcol).value)
                elif testvar.find('Bluffs') != -1:
                    if testvar.find('Illinois') != -1:
                        ws.cell(row=iterationrow, column=targetcol).value = 'Bluffs (Illinois); Scott County (Illinois)'
                        print(ws.cell(row=iterationrow, column=targetcol).value)
                    ...
                    print(ws.cell(row=iterationrow, column=targetcol).value)
                elif testvar.startswith('Lucas County') != -1 :
